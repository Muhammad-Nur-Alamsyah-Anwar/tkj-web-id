...
## <Icon name="puzzle" class="inline-block align-text-bottom mr-2" /> Kabel UTP (Tembaga)
...
### <Icon name="pencil" class="inline-block align-text-bottom mr-2" /> Kode Warna (Hukum Wajib Hafal)
...
## <Icon name="star" class="inline-block align-text-bottom mr-2" /> Fiber Optic (Kaca)
...
:::danger[BAHAYA NYATA! KACA TAK KASAT MATA]
Potongan core Fiber Optic itu **kaca tajam tak kasat mata**. Jangan anggap remeh!

*   **JANGAN DITIUP**, nanti masuk mata/terhirup.
*   **JANGAN DIBUANG SEMBARANGAN**.
*   **Selalu siapkan lakban hitam** untuk memungut/menempelkan sisa potongan kaca.

> **True Story (Pengalaman Penulis):**
> *"Saya pernah tidak sengaja menginjak potongan core fiber optic. Kacanya masuk ke dalam kaki, patah di dalam, dan tidak bisa dikeluarkan sampai sekarang. Rasanya ngilu dan jadi pelajaran seumur hidup. Jangan sampai ini kejadian di kalian. Selalu siapkan lakban untuk pungut sampah core!"*
:::
...
### <Icon name="warning" class="inline-block align-text-bottom mr-2" /> Tipe Konektor (Jangan Salah Colok!)
...
### <Icon name="list-format" class="inline-block align-text-bottom mr-2" /> Kode Warna 12 Core (The Legend)
...
### <Icon name="setting" class="inline-block align-text-bottom mr-2" /> Alat Perang FO (Mahal!)
