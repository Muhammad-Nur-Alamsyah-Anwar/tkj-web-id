...
## <Icon name="laptop" class="inline-block align-text-bottom mr-2" /> Virtualization & Lab
...
## <Icon name="setting" class="inline-block align-text-bottom mr-2" /> Network Configuration
...
## <Icon name="pencil" class="inline-block align-text-bottom mr-2" /> Development & Text Editor
...
## <Icon name="list-format" class="inline-block align-text-bottom mr-2" /> Utilities Tambahan
...
### <Icon name="download" class="inline-block align-text-bottom mr-2" /> Download Checklist
